...
class ConceptSuggester:
    ...
    def suggest_concepts(
        ...
        suggestions.extend(self._generate_label_based_suggestions(description, concept_type, max_suggestions))
    ...
    def _generate_label_based_suggestions(
        self, description: str, concept_type: str, max_suggestions: int
    ) -> list[SuggestedConcept]:
    ...
    def _find_potential_parents(self, description: str, concept_type: str) -> list[str]:
        ...
        _ = self.ontology_loader.get_concepts_by_type(concept_type)

        # Find similar concepts
        matches = self.concept_matcher.match_concepts(description, max_results=10, min_confidence=0.3)

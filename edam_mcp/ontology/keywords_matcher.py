...
class KeywordMatcher:
    ...
    def _prepare_embeddings(self) -> None:
        ...
        for uri, description in self.term_descriptions.items():
            embedding = self.embedding_model.encode(description, show_progress_bar=False)
    ...
    def match_by_list_embeddings(self, keywords: list[str], threshold: float = 0.3) -> list[KeywordMatch]:
        ...
        keyword_embeddings = self.embedding_model.encode(keywords, show_progress_bar=False)
    ...
    def match_by_joined_embedding(self, keywords: list[str], threshold: float = 0.3) -> list[KeywordMatch]:
        ...
        query_embedding = self.embedding_model.encode(joined_keywords, show_progress_bar=False)
